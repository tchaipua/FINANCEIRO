...
export const UI_PATTERNS: UiPatternDefinition[] = [
  ...
  },
  {
    ...
    summary:
      'BARRA OPERACIONAL DE LISTAGEM COM ACAO DE INCLUIR NO INICIO DA LINHA DA BUSCA QUANDO EXISTIR, BOTAO COLUNAS E BOTAO DE EXPORTACAO/IMPRESSAO A ESQUERDA, CONTROLES/TIPO SEMAFORO NO CENTRO E CONTADOR DE REGISTROS A DIREITA, USADA SOMENTE EM TELAS COM GRID E SEM FAIXA AZUL INTERNA DUPLICANDO TITULO/DESCRICAO.',
    documentationPath:
