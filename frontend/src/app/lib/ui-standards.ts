...
export const UI_PATTERNS: UiPatternDefinition[] = [
  ...
  },
  {
    ...
    summary:
      'BARRA OPERACIONAL DE LISTAGEM COM ACAO DE INCLUIR NO INICIO DA LINHA DA BUSCA QUANDO EXISTIR, BOTAO COLUNAS E BOTAO DE EXPORTACAO/IMPRESSAO A ESQUERDA E SEMAFORO AO LADO DO BOTAO DE EXPORTACAO. O FINAL DO GRID TEM DOIS MODELOS: SEM TOTAIS AGREGADOS NAO USA FAIXA AZUL E MOSTRA APENAS TOTAL REGISTROS NO RODAPE; COM TOTAIS AGREGADOS USA FAIXA AZUL #1D4F91 COM TOTAL REGISTROS EM PILL BRANCO E VALORES ALINHADOS NAS COLUNAS.',
    documentationPath:
  ...
  },
  {
    ...
    summary:
      'QUANDO O FINANCEIRO ABRIR DENTRO DE UMA VERTICAL COMO A ESCOLA, O MENU LATERAL AZUL, O CABECALHO E O NOME TECNICO VISIVEL DEVEM CONTINUAR NA VERTICAL HOSPEDEIRA. A TELA INTERNA DO FINANCEIRO DEVE MOSTRAR APENAS O CONTEUDO CENTRAL E NUNCA DUPLICAR O IDENTIFICADOR VISIVEL; TODA TELA NOVA DEVE TER UM UNICO NOME TECNICO VISIVEL E EXCLUSIVO.',
    documentationPath:
  ...
  },
  {
    ...
    summary:
      'TODO NOVO POPUP/MODAL DO FINANCEIRO DEVE NASCER COM LOGOTIPO NO CABECALHO, NOME TECNICO EXCLUSIVO E BLOCO "TELA:" NO RODAPE COM COPIA E ABERTURA DA AUDITORIA SQL. O MODAL DE AUDITORIA USA ABAS NO CABECALHO, BOTOES FECHAR/COPIAR SQL A DIREITA E COPIAR SQL SOMENTE NA ABA SQL.',
    documentationPath:
