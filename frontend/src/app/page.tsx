    ...
    try {
      ...
      setOverview(
        await getJson<DashboardOverview>(
          `/dashboard/overview${buildFinanceQueryString(runtimeContext)}`,
        ),
      );
    } catch (currentError) {
      setOverview(null);
    ...
    <div className="space-y-6">
      <section className={`${cardClass} overflow-hidden`}>
        <div className="bg-gradient-to-r from-[#153a6a] via-[#1d4f91] to-[#2563eb] px-6 py-6 text-white">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              <div className="text-xs font-black uppercase tracking-[0.24em] text-cyan-200">Financeiro desacoplado</div>
            ...
            <div className="rounded-2xl border border-white/15 bg-white/10 px-4 py-3 text-sm font-semibold text-blue-50">
              <div className="text-[11px] font-black uppercase tracking-[0.18em] text-cyan-100">Status da carga</div>
      ...
      <section className="grid gap-4 xl:grid-cols-3">
        <article className={`${cardClass} p-5`}>
          <div className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-500">Valor aberto</div>
        ...
        <article className={`${cardClass} p-5`}>
          <div className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-500">Recebido no mês</div>
          <div className="mt-3 text-3xl font-black text-slate-900">
        ...
        <article className={`${cardClass} p-5`}>
          <div className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-500">Parcelas vencidas</div>
          <div className="mt-3 text-3xl font-black text-slate-900">
      ...
      <section className="grid gap-6 xl:grid-cols-2">
        <article className={`${cardClass} overflow-hidden`}>
          <div className="border-b border-slate-100 px-6 py-5">
            <div className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-500">Lotes recentes</div>
        ...
        <article className={`${cardClass} overflow-hidden`}>
          <div className="border-b border-slate-100 px-6 py-5">
            <div className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-500">Caixa recente</div>
