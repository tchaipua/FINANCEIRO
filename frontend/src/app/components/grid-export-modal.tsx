  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-sm">
      <div className="flex max-h-[94vh] w-full max-w-5xl flex-col overflow-hidden rounded-[28px] bg-white shadow-2xl">
        <div className={`flex items-start justify-between gap-4 border-b px-6 py-4 ${blueHeader ? 'border-blue-300/30 bg-gradient-to-r from-[#153a6a] via-[#1d4f91] to-[#2563eb] text-white' : 'border-slate-100 bg-slate-50'}`}>
          <div className="flex min-w-0 items-center gap-4">
            <div className="flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-white/30 bg-white shadow-sm">
              {brandingLogoUrl ? (
                ...
                <img src="/logo-msinfor.jpg" alt="Logotipo do Financeiro" className="h-full w-full object-contain" />
              )}
            </div>
          ...
          <button
            ...
            className={`inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-red-300/80 bg-red-600 text-white shadow-lg shadow-red-950/25 transition hover:bg-red-700 ${blueHeader ? '' : 'text-white'}`}
          >
