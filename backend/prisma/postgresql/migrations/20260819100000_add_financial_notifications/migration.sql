CREATE TABLE "financial_notification_preferences" (
    ...
    "canceledBy" TEXT,
    CONSTRAINT "financial_notification_preferences_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "financial_notification_deliveries" (
    ...
    "updatedAt" TIMESTAMPTZ(3) NOT NULL,
    "updatedBy" TEXT,
    CONSTRAINT "financial_notification_deliveries_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "financial_notification_audit_events" (
    ...
    "createdAt" TIMESTAMPTZ(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "createdBy" TEXT,
    CONSTRAINT "financial_notification_audit_events_pkey" PRIMARY KEY ("id")
);
...
ALTER TABLE "financial_notification_preferences" ADD CONSTRAINT "financial_notification_preferences_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "financial_notification_preferences" ADD CONSTRAINT "financial_notification_preferences_subjectId_fkey" FOREIGN KEY ("subjectId") REFERENCES "finance_access_subjects"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "financial_notification_deliveries" ADD CONSTRAINT "financial_notification_deliveries_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "financial_notification_deliveries" ADD CONSTRAINT "financial_notification_deliveries_subjectId_fkey" FOREIGN KEY ("subjectId") REFERENCES "finance_access_subjects"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "financial_notification_audit_events" ADD CONSTRAINT "financial_notification_audit_events_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
